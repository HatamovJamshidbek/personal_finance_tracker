...
func (x *Goal) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
func (x *GoalRequest) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
var file_goal_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x02, 0x0a, 0x04, 0x47, 0x6f, 0x61,
	...
	0x72, 0x65, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x36, 0x0a, 0x08, 0x64, 0x65,
	0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67,
	...
	0x22, 0xd6, 0x01, 0x0a, 0x0b, 0x47, 0x6f, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x65, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x36, 0x0a, 0x08, 0x64, 0x65, 0x61,
...
var file_goal_proto_depIdxs = []int32{
	5,  // 0: Goal.deadline:type_name -> google.protobuf.Timestamp
	5,  // 1: Goal.created_at:type_name -> google.protobuf.Timestamp
	5,  // 2: Goal.updated_at:type_name -> google.protobuf.Timestamp
	5,  // 3: GoalRequest.deadline:type_name -> google.protobuf.Timestamp
	0,  // 4: Goals.goals:type_name -> Goal
	0,  // 5: GoalProgressReport.goal:type_name -> Goal
	3,  // 6: GoalProgressesReport.goal_progresses_report:type_name -> GoalProgressReport
	1,  // 7: GoalService.CreateGoal:input_type -> GoalRequest
	0,  // 8: GoalService.UpdateGoal:input_type -> Goal
	6,  // 9: GoalService.GetGoal:input_type -> PrimaryKey
	7,  // 10: GoalService.GetListGoals:input_type -> GetListRequest
	6,  // 11: GoalService.DeleteGoal:input_type -> PrimaryKey
	6,  // 12: GoalService.GetGoalReportProgress:input_type -> PrimaryKey
	0,  // 13: GoalService.CreateGoal:output_type -> Goal
	0,  // 14: GoalService.UpdateGoal:output_type -> Goal
	0,  // 15: GoalService.GetGoal:output_type -> Goal
	2,  // 16: GoalService.GetListGoals:output_type -> Goals
	8,  // 17: GoalService.DeleteGoal:output_type -> google.protobuf.Empty
	4,  // 18: GoalService.GetGoalReportProgress:output_type -> GoalProgressesReport
